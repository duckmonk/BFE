...
import { Box, Typography, TextField, MenuItem, Snackbar, Alert, Accordion, AccordionSummary, AccordionDetails, Button } from '@mui/material';
...
const TaskFinalQuestionnaire = forwardRef(({ clientCaseId, userId }: { clientCaseId: number, userId: string }, ref) => {
  ...
  useEffect(() => {
    if (clientCaseId) {
      taskApi.getFinalQuestionnaire(clientCaseId).then((res: { data: any }) => {
        if (res && res.data) {
...
export default TaskFinalQuestionnaire; 